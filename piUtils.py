...
#
# May 2010:
# Extended to handle spectroscopy data (x-calibration)
...
def getSpectrum(spefile):
    ...
    if xcal['SpecGlueFlag']:
        ...
        if xcal['polynom_order'] != '\x02':
            """
            I think that this means that the file has a second-order wavelength calibration, 
            but it's not clear to me why the wouldn't use an integer to denote polynom_order.
            Consequently, I'm not sure how to know exactly what the order of the calibration
            is if this flag changes... Let's hope it never does. :-)
            """
